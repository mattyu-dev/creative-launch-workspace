...
<head>
  ...
  <link rel="icon" href="data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2032%2032%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20rx%3D%227%22%20fill%3D%22%23b83b1f%22%2F%3E%3C%2Fsvg%3E" type="image/svg+xml">
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .focus-actions .button-primary { color: var(--brand); border-color: #fff; background: #fff; }
      ...
      <div class="guided-body">
        ...
        <div id="guided-step-three" hidden>
          <div class="guided-actions" id="guided-step-three-actions">
            ...
            <a class="guided-return" id="guided-case-study" href="index.html#about">See how Mathieu built the product</a>
