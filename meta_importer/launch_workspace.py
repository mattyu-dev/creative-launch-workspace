...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .focus-actions .button-primary { color: var(--ink); border-color: var(--action); background: var(--action); }
    .focus-actions .button-primary:hover { color: var(--ink); border-color: var(--action-hover); background: var(--action-hover); }
    ...
    .button-primary { color: var(--ink); border-color: var(--action); background: var(--action); }
