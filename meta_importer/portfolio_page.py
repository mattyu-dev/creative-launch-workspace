...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;color:var(--ink);background:var(--canvas);font:400 15px/1.58 var(--sans);-webkit-font-smoothing:antialiased}a{color:inherit}a:focus-visible,button:focus-visible{outline:2px solid #275fb8;outline-offset:3px}.page{width:min(1240px,calc(100% - 48px));margin-inline:auto}.skip-link{position:fixed;left:16px;top:-80px;z-index:30;padding:10px 14px;border-radius:5px;color:#fff;background:var(--forest)}.skip-link:focus{top:12px}
    ...
    .difference-grid{display:grid;grid-template-columns:repeat(3,1fr);border:1px solid var(--line);background:var(--surface)}.difference{min-height:190px;padding:23px;border-right:1px solid var(--line)}.difference:last-child{border-right:0}.difference b{display:block;margin-bottom:22px;color:var(--oxide);font:750 10px/1 var(--mono)}.difference h3{font-size:21px}.difference p{margin:7px 0 0;color:var(--muted);font-size:13px}.ai-proof-head{display:flex;align-items:end;justify-content:space-between;gap:24px;margin:30px 0 12px}.ai-proof-head strong{font:500 22px/1.2 var(--serif)}.ai-proof-head a{color:var(--forest);font-size:12px;font-weight:750;text-underline-offset:4px}.ai-proof-grid{display:grid;grid-template-columns:1fr 1fr;border:1px solid var(--line-strong);background:var(--surface)}.ai-proof{min-width:0;padding:20px 22px}.ai-proof+.ai-proof{border-left:1px solid var(--line)}.ai-proof header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:0;border:0;background:transparent}.ai-proof header span{color:var(--oxide);font:750 10px/1 var(--mono);letter-spacing:.05em}.ai-proof header strong{font-size:12px}.ai-proof.accepted header strong{color:var(--forest)}.ai-proof.abstained header strong{color:var(--oxide)}.ai-proof dl{margin:16px 0 0}.ai-proof dl div{display:grid;grid-template-columns:145px 1fr;gap:12px;padding:8px 0;border-top:1px solid var(--line)}.ai-proof dt{color:var(--muted);font-size:11px}.ai-proof dd{min-width:0;margin:0;overflow-wrap:anywhere;font-size:12px;font-weight:650}.ai-proof code{font-family:var(--mono);font-size:11px}.ai-proof-note{margin:9px 0 0;color:var(--muted);font-size:10px}
    ...
    @media(max-width:980px){.hero-layout{grid-template-columns:1fr;gap:24px}.hero-copy,.hero-product,.hero-cta,.hero-byline{grid-column:1;grid-row:auto}.hero-copy{order:1}.hero-product{order:2;max-width:760px}.hero-cta{order:3}.hero-cta .actions{margin-top:0}.hero-byline{order:4;margin-top:0}.product-window{height:420px}.section-head{grid-template-columns:1fr;gap:14px}.architecture{grid-template-columns:1fr}.evidence-grid{grid-template-columns:1fr 1fr}.evidence:nth-child(2){border-right:0}.evidence:nth-child(-n+2){border-bottom:1px solid var(--line)}.about{grid-template-columns:1fr}.about>div+div{border-left:0;border-top:1px solid var(--line)}}
    @media(max-width:700px){.page{width:calc(100% - 28px)}.nav-links>a:not(.nav-cta){display:none}.hero{padding:34px 0}.hero h1{font-size:43px}.product-window{height:310px}.product-window img{object-position:center}.annotation{display:none}.proof-strip,.guide-grid,.difference-grid,.ai-proof-grid,.proof-paths,.production-grid,.metrics{grid-template-columns:1fr}.proof-item,.proof-item+.proof-item,.guide-step,.guide-step+.guide-step,.proof-path,.proof-path+.proof-path{padding:15px 0;border-right:0;border-bottom:1px solid var(--line)}.proof-item:last-child,.guide-step:last-child,.proof-path:last-child{border-bottom:0}.before-after{grid-template-columns:1fr}.comparison+.comparison{border-left:0;border-top:1px solid var(--line)}.guide-action{align-items:flex-start;flex-direction:column}.difference{min-height:0;border-right:0;border-bottom:1px solid var(--line)}.difference:last-child{border-bottom:0}.ai-proof-head{align-items:flex-start;flex-direction:column;gap:6px}.ai-proof+.ai-proof{border-left:0;border-top:1px solid var(--line)}.ai-proof dl div{grid-template-columns:118px 1fr}.diagram{display:none}.architecture-stack{display:block}.metric-group{border-right:0;border-bottom:1px solid var(--line)}.metric-group:last-child{border-bottom:0}.proof-band{margin-inline:-14px;padding:30px 20px}.proof-path,.proof-path+.proof-path{border-bottom-color:rgba(255,255,255,.22)}.evidence-grid{grid-template-columns:1fr}.evidence,.evidence:nth-child(2){border-right:0;border-bottom:1px solid var(--line)}.evidence:last-child{border-bottom:0}.about>div{padding:24px}.contribution{grid-template-columns:1fr;gap:4px}.final-cta{margin-inline:-14px;padding:42px 20px}.footer-row{flex-direction:column;gap:8px}}
...
<body>
  ...
  <main id="main">
    ...
    <section class="page section" aria-labelledby="spreadsheet-title">
      ...
      <p class="ai-proof-note">Synthetic contract examples backed by the committed proposal receipt and missing-destination evaluation case. Live-model quality is not claimed.</p>
    </section>
