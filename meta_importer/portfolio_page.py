...
<head>
  ...
  <meta name="twitter:image" content="https://mattyu-dev.github.io/creative-launch-workspace/assets/social-card-v1-5.png">
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "image": "https://mattyu-dev.github.io/creative-launch-workspace/assets/social-card-v1-5.png",
        "author": { "@id": "https://mattyu-dev.github.io/creative-launch-workspace/#mathieu" },
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;color:var(--ink);background:var(--canvas);font:400 15px/1.58 var(--sans);-webkit-font-smoothing:antialiased}a{color:inherit}a:focus-visible,button:focus-visible{outline:2px solid #275fb8;outline-offset:3px}.page{width:min(1240px,calc(100% - 48px));margin-inline:auto}.skip-link{position:fixed;left:16px;top:-80px;z-index:30;padding:10px 14px;border-radius:5px;color:#fff;background:var(--forest)}.skip-link:focus{top:12px}
    ...
    .production-grid{display:grid;grid-template-columns:1fr 1fr;gap:28px}.production-card{padding:26px;border:1px solid var(--line);background:var(--surface)}.production-card h3{margin-bottom:14px}.production-card ol,.production-card ul{margin:0;padding-left:19px;color:var(--body)}.production-card li{padding:5px 0}.production-card.warning{background:var(--surface-soft)}.metrics-label{margin:30px 0 12px;color:var(--oxide);font:750 10px/1 var(--mono);letter-spacing:.06em;text-transform:uppercase}.metrics{display:flex;flex-wrap:wrap;gap:8px}.metrics span{padding:7px 9px;border:1px solid var(--line-strong);border-radius:999px;color:var(--body);background:var(--surface);font-size:12px}
    ...
    @media(max-width:980px){.hero-layout{grid-template-columns:1fr;gap:24px}.hero-copy,.hero-product,.hero-byline{grid-column:1;grid-row:auto}.hero-product{max-width:760px}.hero-mobile-author{display:block}.hero-byline{margin-top:0}.product-window{height:420px}.section-head{grid-template-columns:1fr;gap:14px}.architecture{grid-template-columns:1fr}.evidence-grid{grid-template-columns:1fr 1fr}.evidence:nth-child(2){border-right:0}.evidence:nth-child(-n+2){border-bottom:1px solid var(--line)}.about{grid-template-columns:1fr}.about>div+div{border-left:0;border-top:1px solid var(--line)}}
    @media(max-width:700px){.page{width:calc(100% - 28px)}.nav-links span,.nav-links a:not(.nav-cta){display:none}.hero{padding:40px 0 34px}.hero h1{font-size:43px}.product-window{height:310px}.annotation{font-size:10px}.a1{left:8px;top:9%}.a2{right:8px;top:47%}.a3{left:10px;bottom:38px}.proof-strip,.guide-grid,.difference-grid,.proof-paths,.production-grid{grid-template-columns:1fr}.proof-item,.proof-item+.proof-item,.guide-step,.guide-step+.guide-step,.proof-path,.proof-path+.proof-path{padding:15px 0;border-right:0;border-bottom:1px solid var(--line)}.proof-item:last-child,.guide-step:last-child,.proof-path:last-child{border-bottom:0}.before-after{grid-template-columns:1fr}.comparison+.comparison{border-left:0;border-top:1px solid var(--line)}.guide-action{align-items:flex-start;flex-direction:column}.difference{min-height:0;border-right:0}.difference:nth-last-child(-n+3){border-bottom:1px solid var(--line)}.difference:last-child{border-bottom:0}.proof-band{margin-inline:-14px;padding:30px 20px}.proof-path,.proof-path+.proof-path{border-bottom-color:rgba(255,255,255,.22)}.evidence-grid{grid-template-columns:1fr}.evidence,.evidence:nth-child(2){border-right:0;border-bottom:1px solid var(--line)}.evidence:last-child{border-bottom:0}.about>div{padding:24px}.contribution{grid-template-columns:1fr;gap:4px}.final-cta{margin-inline:-14px;padding:42px 20px}.footer-row{flex-direction:column;gap:8px}}
    @media(max-width:430px){.hero h1{font-size:37px}.lead{font-size:16px}.actions{align-items:stretch;flex-direction:column}.actions .button,.actions .text-link{width:100%;text-align:center}.product-window{height:270px}.annotation{max-width:145px}.a3{display:none}.product-frame figcaption{display:block}.diagram{padding:10px}.diagram text{font-size:11px}.diagram .mono-text{font-size:8px}}
...
<body>
  ...
  <header>
    <nav class="page" aria-label="Primary navigation">
      ...
      <div class="nav-links"><span>Built by Mathieu Petroni</span><a href="https://www.linkedin.com/in/mathieu-petroni/" rel="me external">LinkedIn</a><a href="https://github.com/mattyu-dev/creative-launch-workspace" rel="external">GitHub</a><a class="nav-cta" href="workspace.html?guided=1">Try the demo</a></div>
    </nav>
  </header>
  <main id="main">
    <section class="page hero" id="top">
      <div class="hero-layout">
        <div class="hero-copy">
          ...
          <p class="lead">I built a governed AI workflow that turns an ambiguous campaign brief and a 100-row Meta creative batch into a clear decision queue. Clean rows require no review action, blockers return to the right owner, and ambiguous cases stay with a human.</p>
          ...
          <div class="hero-mobile-author">Mathieu Petroni · AI Automation Lead</div>
        </div>
        <div class="hero-product">
          <figure class="product-frame">
            ...
            <figcaption><strong>Interactive product · no signup</strong><span>Local-only decision state</span></figcaption>
          </figure>
          <span class="annotation a1"><b>30</b> rows pass offline checks</span>
          <span class="annotation a2"><b>60</b> blockers routed to an owner</span>
          <span class="annotation a3"><b>10</b> decisions reserved for a human</span>
        </div>
      ...
      <div class="proof-strip" aria-label="Reproducible fixture evidence">
        ...
        <div class="proof-item"><strong>60</strong><span>blocked rows return with an owner and proposed fix</span></div>
        <div class="proof-item"><strong>10</strong><span>ambiguous cases wait for a human decision</span></div>
      </div>
      <p class="fixture-note">Exclusive states across a 100-row synthetic fixture. These are reproducible test outcomes, not customer or business results.</p>
    </section>

    <section class="page section" aria-labelledby="problem-title">
      <div class="section-head"><div><div class="eyebrow">The operational problem</div><h2 id="problem-title">The expensive part is usually the handoff.</h2></div><p>Briefs, spreadsheets, chat approvals and trafficking checks fragment one launch decision across too many places.</p></div>
      <div class="before-after">
        ...
        <div class="comparison after"><h3>With the workspace</h3><ul><li>One decision queue holds the launch state.</li><li>Clean rows require no action.</li><li>Every issue names an owner and proposed fix.</li><li>Ambiguity requires an explicit human decision.</li><li>Problems surface before platform handoff.</li></ul></div>
      </div>
      <p class="purpose">The purpose is not to remove people from launch operations. It is to remove repetitive inspection, make exceptions visible and preserve human authority over ambiguous or high-risk decisions.</p>
    </section>

    <section class="page section" aria-labelledby="demo-title">
      <div class="section-head"><div><div class="eyebrow">Guided interactive demo</div><h2 id="demo-title">Make one real decision, then inspect the evidence.</h2></div><p>The guide uses the same local state and audit path as the full 100-row workspace.</p></div>
      <div class="guide-grid"><div class="guide-step"><b>01 · FIND</b><h3>See the ambiguous row.</h3><p>The guide selects a possible duplicate and names the issue, owner and proposed fix.</p></div><div class="guide-step"><b>02 · DECIDE</b><h3>Exercise human authority.</h3><p>Confirm reuse, request a fix or block launch. No option can call Meta.</p></div><div class="guide-step"><b>03 · VERIFY</b><h3>Inspect the local audit event.</h3><p>See what changed, which reviewer role was recorded and the explicit external-write boundary.</p></div></div>
      <div class="guide-action"><p><strong>Nothing to configure.</strong><br>Synthetic data, local browser state and no platform write path.</p><a class="button" href="workspace.html?guided=1">Start the guided review &rarr;</a></div>
    </section>
    ...
    <section class="page section" aria-labelledby="spreadsheet-title">
      ...
      <div class="difference-grid"><div class="difference"><b>01</b><h3>Typed contracts</h3><p>Known fields and allowed values replace unstructured columns.</p></div><div class="difference"><b>02</b><h3>Grounded proposals</h3><p>AI suggestions carry source evidence or explicitly abstain.</p></div><div class="difference"><b>03</b><h3>Deterministic QA</h3><p>Policy code verifies every launch row and fails closed.</p></div><div class="difference"><b>04</b><h3>Named ownership</h3><p>Every blocker returns to a role with a concrete proposed fix.</p></div><div class="difference"><b>05</b><h3>Versioned evaluation</h3><p>Cases, rules and artifacts can be regenerated and challenged.</p></div><div class="difference"><b>06</b><h3>Review-only export</h3><p>The output is inspectable and cannot publish or change a live campaign.</p></div></div>
    </section>
    ...
    <section class="page section" aria-labelledby="evidence-title">
    ...
    <section class="page section" aria-labelledby="production-title">
      <div class="section-head"><div><div class="eyebrow">Production path</div><h2 id="production-title">A reference implementation with a serious next-proof plan.</h2></div><p>The boundaries are not an apology. They are the order in which I would reduce production risk.</p></div>
      ...
      <div class="metrics-label">Proposed production pilot metrics · not measured results</div><div class="metrics"><span>Operator minutes / 100 creatives</span><span>Rows cleared without manual inspection</span><span>Blocker precision and false-negative rate</span><span>Defects found before trafficking</span><span>Rework loops per batch</span><span>Time to launch readiness</span><span>Correct-owner routing rate</span><span>Human override rate</span><span>Model abstention rate</span><span>Audit completeness</span></div>
    </section>

    <section class="page section" aria-labelledby="about-title">
      <div class="about"><div><div class="eyebrow">About Mathieu</div><h2 id="about-title">I build governed AI workflows for operational teams.</h2><p>I designed and implemented this project end to end, combining nine years of growth and performance marketing experience with product thinking, automation and data systems.</p><div class="skills"><span>Python</span><span>JavaScript</span><span>Structured Outputs</span><span>AI evaluations</span><span>Human-in-the-loop systems</span><span>Threat modelling</span><span>CI/CD</span><span>Paid-media operations</span></div><div class="actions"><a class="button" href="https://www.linkedin.com/in/mathieu-petroni/" rel="me external">Discuss this project</a><a class="text-link" href="https://github.com/mattyu-dev" rel="me external">View my GitHub &rarr;</a></div></div><div><div class="eyebrow">My contribution</div><div class="contribution-list"><div class="contribution"><b>Product</b><span>Problem framing, workflow design and business-to-technical translation</span></div><div class="contribution"><b>AI system</b><span>Provider isolation, grounded proposals, abstention and evaluation design</span></div><div class="contribution"><b>Engineering</b><span>Typed contracts, deterministic validators, local persistence and audit state</span></div><div class="contribution"><b>Trust</b><span>Threat model, fail-closed policy and explicit platform boundaries</span></div><div class="contribution"><b>Quality</b><span>Responsive UX, accessibility, browser QA, CI and reproducible artifacts</span></div></div></div></div>
    </section>

    <section class="page final-cta" aria-labelledby="contact-title"><div class="eyebrow">Let’s talk</div><h2 id="contact-title">Building an AI workflow where trust matters?</h2><p>I would be happy to discuss the product decisions, architecture, evaluation strategy or how this approach could apply to another operational workflow.</p><div class="actions"><a class="button" href="https://www.linkedin.com/in/mathieu-petroni/" rel="me external">Connect with Mathieu</a><a class="text-link" href="https://github.com/mattyu-dev/creative-launch-workspace">Explore the source &rarr;</a></div></section>
  </main>
  <footer><div class="page footer-row"><span>Creative Launch Workspace · v1.5.0 · Updated <time datetime="2026-07-13">13 July 2026</time></span><span>MIT licensed · Synthetic reference implementation · <a href="https://github.com/mattyu-dev/creative-launch-workspace">Source</a></span></div></footer>
</body>
</html>
"""
