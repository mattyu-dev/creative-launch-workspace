...
from meta_importer.portfolio_v20 import (
    render_case_study_page_v20,
    render_portfolio_page_v20,
    render_social_card_page_v20,
)


def render_portfolio_page() -> str:
    return render_portfolio_page_v20()


def render_case_study_page() -> str:
    return render_case_study_page_v20()


def render_social_card_page() -> str:
    return render_social_card_page_v20()
