...
<head>
  ...
  <style>
    :root {{ --canvas:#f6f7f5;--surface:#ffffff;--soft:#eef0ed;--ink:#151817;--body:#3e4541;--muted:#636b66;--line:#d8ddd9;--strong:#b8c0ba;--brand:#c83b24;--brand-hover:#ae311d;--brand-soft:#fbe8e2;--success:#176143;--success-soft:#e3eee8;--red:#9e342b;--red-soft:#f3e1dd;--font-serif:"Iowan Old Style",Charter,Georgia,serif;--font-mono:ui-monospace,SFMono-Regular,Menlo,monospace;}}
